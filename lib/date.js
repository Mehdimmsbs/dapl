...
/* Returns today's local date as an ISO date string. */
...
/* Keeps compatibility with existing calendar components. */
export const isoToday = getLocalIsoDate();
...
/* Converts a weekday name into its JavaScript index. */
export function weekdayNameIndex(weekday) {
    const weekdays = [
        "sunday",
        "monday",
        "tuesday",
...
export function getAdjacentMonthDate(
    currentDate,
    direction,
    calendar,
) {
